...
| 2 | Complete and send pre go-live checklist | Both | After user acceptance testing (UAT) complete | Customer/Partner | Follow the instructions provided in the "FastTrack Go-live Assessment/Review" section later in this topic. |
| 3 | Project Go-Live assessment/review (FastTrack Essentials) | Both | 3-business days for initial report, plus additional time for mitigation, if required | Microsoft-FastTrack Solution Architect | Solution Architect delivers assessment/review after checklist is received and continues review until questions are clarified and mitigations are in place, if applicable. |
|  | Go-live Assessment/Review workshop (FastTrack) | Both | To coordinate with architect assigned | Microsoft-FastTrack Solution Architect |  |
| 4 | Release for production deployment | Microsoft Managed | Immediate upon successfully completed assessment/review | Microsoft-FastTrack Solution Architect | Do not submit production request until the assessment/review is successfully completed. |
|  |  | Self-Service | Immediate upon successfully completed assessment/review and **Configure** button is enabled | Microsoft-FastTrack Solution Architect | For Self-Service deployment, the **Configure** button remains disabled until the assessment/review is complete. |
| 5 | Production deployment request | Microsoft Managed | Self-service | Customer/Partner | The production deployment request should only be submitted after the FastTrack Architect has finished the assessment/review. |
|  |  | Self-Service | Self-service | Customer/Partner | After the assessment/review is complete, the **Configure** button will be enabled and customer will be able to request the production deployment. |
...
|  |  | Self-Service | An average of 30 minutes | Microsoft-FastTrack Solution Architect | The deployment could take an average of 30 minutes after the assessment/review has completed and the production environment has been requested. For more information, see [Deploy a new environment](../../dev-itpro/deployment/deployenvironment-newinfrastructure.md). |
...
> [!NOTE]
> For Self-Service environments, the **Configure** button will only become available after the Solution Architect has signed off on the assessment/review. 
...
## FastTrack Go-live assessment/review

All customers must complete a go-live review with the Microsoft FastTrack team before their production environment can be deployed. This assessment/review should be successfully completed before you request your production environment. If you aren't familiar with Microsoft FastTrack, see [FastTrack for Dynamics 365 home page](/dynamics365/fasttrack/).
...
After the checklist is submitted, a Microsoft solution architect will review the project and provide an assessment/review that describes the potential risks, best practices, and recommendations for a successful go-live of the project. In some cases, the solution architect might highlight risk factors and ask for a mitigation plan. When the assessment/review is completed, the solution architect will indicate that you're ready to request the production environment in LCS.

For Microsoft Managed environments, if you request the production environment before the assessment/review is completed, the deployment will remain in the **Queued** state until the assessment/review is successfully completed. For Self-Service environments, the **Configure** button to request production will be only enabled after the assessment/review is completed. 
...
After you've completed the analysis, design and develop, and test phases in the LCS methodology, and the go-live assessment/review has concluded that the project is ready, you can request your production environment.
